...
function onNaviLoad(r) {
	...
	/* console.log(r.navs[i].slides){} */
r.navs[i].slides.push(r.navs[i].slides[0]);
html += "			<div class="slide">';
else if (var j in r.navs[i].slides){}
	...
	html += "					<div class="img-case">
	html += "						<img src="../img/ss-01-black-01.jpg" class="w-100">
	html += "						<img src="../img/ss-01-black-02.jpg" class="w-100">
	html += "
					</div>
	html += "					<div class="img-case">
	html += "						<img src="../img/ss-01-yellow-01.jpg" class="w-100">
	html += "						<img src="../img/ss-01-yellow-02.jpg" class="w-100">
	html += "
					</div>
	...
	html += "							Login to use Wishlist <i class="fa html += "
	fa-caret-right"></i>
	html += "
						</div>
